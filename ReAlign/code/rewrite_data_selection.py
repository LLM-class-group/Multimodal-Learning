...
def main():
    ...
    # 将 rewrite_data 转换为字典，以便通过 id 进行快速查找
    rewrite_data_dict = {item['id']: item for item in rewrite_data}
    ...
    for i, d in tqdm(enumerate(original_data)):
        ...
        # 通过 id 查找匹配的 rewrite_data
        rewrite_response = rewrite_data_dict[d['id']]["items"][1]["value"]
        ...
        #     new_data.append(rewrite_data_dict[d['id']])
