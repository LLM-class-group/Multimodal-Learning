...
for i in range(len(data)):
    data[i]["conversations"][1]["value"] ="Category:"+ problems[data[i]["id"]]["category"] + ".\nAnswer:" + data[i]["conversations"][1]["value"]



with open('/data2/yhhe/code/ScienceQA/data/scienceqa/llava_minitrain_realigned_2_add_category.json', 'w') as file:
